Feature: Spain Vodafone - Subscription, Unsubscription and DM Flow

 Scenario: Launch the Browser then Add User Agent and Operator IP Range
   Given Launch the browser
    Given Set the Headers with "Vodafone" IP range "23.92.73.0"
  ...
  Scenario: Navigate the Page_Load_Url Delete all the Domain Cookie and  and Set MSISDN in Header
    When Navigate to url "Page_Load_Url"
    When Delete all domain Cookies Value
  ...
  Scenario: Remove Header having mobile number
